 ...
 * Date: 4/10/2014
 * 
 * This simple module calculates encounter levels, standard XP rewards, and standard treasure rewards based on the number of enemies and their
 * challenge ratings.
 */
...
public class EncounterCalculator implements Serializable
{
    ...
    protected final static int[] TREASURE         = {
        300, 600, 900, 1200, 1600, 2000, 2600, 3400, 4500, 5800, 7500, 9800, 13000, 17000, 22000, 28000, 36000, 47000, 61000, 80000, 87000, 96000,
        106000, 116000, 128000, 141000, 155000, 170000, 187000, 206000, 227000, 249000, 274000, 302000, 332000, 365000, 401000, 442000, 486000,
        534000
                                                  };
    ...
    protected static double experience(final double a, final double y)
    {
        ...
        if ((y == 4.0) || (y == 6.0) || (y == 8.0) || (y == 10.0) || (y == 12.0) || (y == 14.0) || (y == 16.0) || (y == 18.0) || (y == 20.0))
        {
            if (x <= 3.0)
            {
    ...
    protected static String findSpotDistance(final String terrainType)
    {
        ...
        switch (terrainType)
        {
            ...
            case "rHills":
                ...
                spotDist = ((EncounterCalculator.xDy(2, 6) * 10.0) + " (2d6x10)");
                break;
            
            case "spForest":
                
                spotDist = ((EncounterCalculator.xDy(3, 6) * 10.0) + " (3d6x10)");
                break;
            
            case "Moor":
            case "DesertDunes":
                
                spotDist = ((EncounterCalculator.xDy(6, 6) * 10.0) + " (6d6x10)");
                break;
            
            case "Desert":
                
                spotDist = ((EncounterCalculator.xDy(6, 6) * 20.0) + " (6d6x20)");
                break;
            
            case "Plains":
                
                spotDist = ((EncounterCalculator.xDy(6, 6) * 40.0) + " (6d6x40)");
                break;
            
            case "mWater":
                
                spotDist = ((EncounterCalculator.xDy(1, 8) * 10.0) + " (1d8x10)");
                break;
            
            case "mpForest":
            case "Swamp":
                
                spotDist = ((EncounterCalculator.xDy(2, 8) * 10.0) + " (2d8x10)");
                break;
            
            case "cWater":
                
                spotDist = ((EncounterCalculator.xDy(4, 8) * 10.0) + " (4d8x10)");
                break;
            
            case "gHills":
                
                spotDist = ((EncounterCalculator.xDy(2, 10) * 10.0) + " (2d10x10)");
                break;
            
            case "Mount":
                
                spotDist = ((EncounterCalculator.xDy(4, 10) * 10.0) + " (4d10x10)");
                break;
    ...
    protected static int treasure(final double a)
    {
        ...
        {
            retVal = ((int)(EncounterCalculator.TREASURE[x2 - 1] + ((x - x2) * (EncounterCalculator.TREASURE[x2] - EncounterCalculator.TREASURE[x2 - 1]))));
        }
        else
        {
