...
public class EncounterCalculator implements Serializable
{
	...
	protected static double experience(final double a, final double y)
	{
		...
		if ((x <= 6.0) && (y <= 1.0))
		{
			...
			{
				retVal = (6.25 * x * (Math.pow(2.0, (EncounterCalculator.even(7.0 - (x - y)) / 2.0)) *
					(11.0 - (x - y) - EncounterCalculator.even(7.0 - (x - y)))));
			}
		
		if ((y == 4.0) || (y == 6.0) || (y == 8.0) || (y == 10.0) || (y == 12.0) ||
			(y == 14.0) || (y == 16.0) || (y == 18.0) || (y == 20.0))
		{
			if (x <= 3.0)
			{
		...
		if ((y == 7.0) || (y == 9.0) || (y == 11.0) || (y == 13.0) ||
			(y == 15.0) || (y == 17.0) || (y == 19.0))
		{
			if (x == 6.0)
			{
	...
	protected static int treasure(final double a)
	{
		...
		if (x < 1.0)
		{
			...
			if (x > x2)
			{
				retVal = ((int)(EncounterCalculator.TREASURE[x2 - 1] + ((x - x2) *
					(EncounterCalculator.TREASURE[x2] - EncounterCalculator.TREASURE[x2 - 1]))));
			}
			else
			{
