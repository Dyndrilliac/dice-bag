...
public final class Creature35E extends Creature
{
    ...
    public final String toString()
    {
        ...
        return String.format(this.getConstants().STRING_FORMAT(),
            this.getStatBlock().getName(),
            this.getStatBlock().getCurHealth(),
            this.getStatBlock().getMaxHealth(),
            this.getStatBlock().getTotalInit(),
            this.getStatBlock().getPosition(),
            status);
    }
