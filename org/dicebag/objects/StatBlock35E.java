 ...
 * It is a companion for the Creature35E class. It represents the stat block for a standard D&D 3.5E creature.
 */
...
public final class StatBlock35E extends StatBlock
{
    ...
    public StatBlock35E(final int curHealth, final int initBonus, final int maxHealth, final String name, final String position)
    {
        super(curHealth, initBonus, maxHealth, name, position);
    }
    
    public StatBlock35E(final int initBonus, final int maxHealth, final String name, final String position)
    {
